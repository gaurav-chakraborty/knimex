    ...
    <main className="min-h-screen bg-slate-950 px-6 py-12 text-slate-200">
      <div className="mx-auto max-w-4xl space-y-12">
        ...
        <section className="space-y-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-emerald-300">Security posture</p>
          <h1 className="text-4xl font-black tracking-tight text-white md:text-6xl">Security policy</h1>
          <p className="max-w-2xl text-lg leading-8 text-slate-400">FileX is designed to keep file transformations close to the user. The product emphasizes explicit review, clear export artifacts, and minimal retention.</p>
        </section>
